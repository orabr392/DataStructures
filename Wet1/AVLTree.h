...
public:
    ...
    AVLTree(AVLTree<dataType1, dataType2> &AVLTree)
    {
    ...
    int inorderToTree(AVLNode<dataType1, dataType2> *node, AVLNode<dataType1, dataType2> *arr, int arrSize, int i)
    {
        if (node == nullptr)
            return i;
    ...
    void combineAVLTrees(AVLTree<dataType1, dataType2> &newTree, AVLTree<dataType1, dataType2> &tree1, AVLTree<dataType1, dataType2> &tree2)
    {
    ...
    AVLNode<dataType1, dataType2> *createEmptyTreeAux(AVLNode<dataType1, dataType2> *parentNode, int height, bool isLeftChild, bool isRightChild)
    {
        if (height < 0)
            return nullptr;
