...
int main()
{
    ...
    // obj->add_team(3, 1, Sport::BOULDERING);
    // obj->add_contestant(1, 1, Sport::BOULDERING, 2);

    // obj->add_contestant_to_team(1, 1);
    // obj->add_contestant_to_team(2, 1);
    // obj->add_contestant_to_team(3, 1);

    // obj->remove_contestant_from_team(1, 1);
    // obj->remove_contestant_from_team(2, 1);
    // obj->remove_contestant_from_team(3, 1);
